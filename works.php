    ...
    <div class="row">
      ...
      <div class="col-sm-8 col-sm-offset-2 section-container-spacer">
        <div class="text-center">
          <h1 class="h2">02 : Portafolio</h1>
          <p>Se muestran los desarrollos hechos y su documentación.</p>
        </div>
      </div>
            ...
            <div class="item active">
              <div class="row">
                <div class="col-sm-4">
                  ...
                  <a href="./calendario.php" title="" class="black-image-project-hover">
                    <img src="./assets/images/work01-hover.jpg" alt="" class="img-responsive">
                  </a>
                  <div class="card-container card-container-lg">
                    <h4>001/003</h4>
                    <h3>Calendario</h3>
                    <p>Aplicación pensada para gestionar los tiempos de un equipo de trabajo, haga clic para conocer mas detalle.</p>
                    <a href="./calendario.php" title="" class="btn btn-default">Detalle</a>
                  </div>
                </div>
                <div class="col-sm-4">
                  <a href="./ingarqmc.php" title="" class="black-image-project-hover">
                    <img src="./assets/images/work02-hover.jpg" alt="" class="img-responsive">
                  </a>
                  <div class="card-container card-container-lg">
                    <h4>002/003</h4>
                    <h3>Sitio INGARQMC</h3>
                    <p>Sitio web desarrollado para la constructora “Ingeniería y Arquitectura MC” haga clic para conocer mas detalle.</p>
                    <a href="./ingarqmc.php" title="" class="btn btn-default">Detalle</a>
                  </div>
                </div>
                <div class="col-sm-4">
                  <a href="./vtp.php" title="" class="black-image-project-hover">
                    <img src="./assets/images/work03-hover.jpg" alt="" class="img-responsive">
                  </a>
                  <div class="card-container card-container-lg">
                    <h4>003/003</h4>
                    <h3>VTP</h3>
                    <p>Aplicación para el control de un inventario, se desarrollo en colaboración con DSE, haga clic para conocer mas detalle.</p>
                    <a href="./vtp.php" title="" class="btn btn-default">Detalle</a>
                  </div>
                </div>
